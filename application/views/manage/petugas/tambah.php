...
<div class="wrapper">
            <div class="container">
				...
				<div class="panel panel-border panel-custom">
					<div class="panel-heading"><i class="fa fa-user"></i> Tambah Petugas</div>
		                  ...
		                  <form class="form-horizontal" method="POST">
		                    ...
		                    <div class="form-group">
		                      ...
		                      <label>Nama Petugas</label>
		                        <input type="text" class="form-control" name="nama" placeholder="Nama Petugas" value="<?= set_value('nama') ?>" >
